            ...
            <table className="w-full border border-slate-500">
              <tbody>
                <NameInput
                  ...
                  registerFirst={register('family_name_kana', { required: "姓(カナ)は必須です" })}
                  registerSecond={register('given_name_kana', { required: "名(カナ)は必須です" })}
                ...
                <NameInput
                  ...
                  placeholderFirst="姓"
                  placeholderSecond="名"
                  registerFirst={register('family_name', { required: "姓は必須です" })}
                  registerSecond={register('given_name', { required: "名は必須です" })}
                  errorFirst={errors.family_name}
                  errorSecond={errors.given_name}
                />
                <BirthdayInput
                  theme="生年月日"
                  register={register('birthday', { required: "誕生日は必須です。", validate: {
                    notAfterToday: () => {
                ...
                <Input
                  ...
                  register={register('email', { required: "メールアドレスは必須です", pattern: {
                ...
                <Input
                  ...
                  register={register('password', { required: "パスワードは必須です", minLength: { value: 8, message: "パスワードは8文字以上です" } })}
                ...
                <Input
                  ...
                  type="text"
                  placeholder="郵便番号"
                  register={register('address_attributes.postal_code', { required: "郵便番号は必須です", pattern: {
                    value: /^\d{3}-?\d{4}$/,
                    message: '郵便番号が不正です'
                  }})}
                ...
                <Input
                  ...
                  type="text"
                  placeholder="都道府県"
                  register={register('address_attributes.prefecture', { required: "都道府県は必須です" })}
                ...
                <Input
                  ...
                  type="text"
                  placeholder="市区町村"
                  register={register('address_attributes.city', { required: "市区町村は必須です" })}
                ...
                <Input
                  ...
                  type="text"
                  placeholder="町域・番地"
                  register={register('address_attributes.address1', { required: "町域・番地は必須です" })}
                ...
                <Input
                  ...
                  register={register('telephone_attributes.phone_number', { required: "携帯番号は必須です", pattern: {
